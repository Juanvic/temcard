...
function Temcard() {
    ...
    const fetchTemtem = async (temtemId) => {
        const response = await fetch(`https://temtem-api.mael.tech/api/temtems/${temtemId}`);
    ...
    const loadTemtem = async (temtemId) => {
        ...
        setTemtemImageSrc(`https://tem.team/static/images/temtem/regular/${formattedNumber}.png`);
        setIsLoading(false);
    };
        ...
        <main className="page">
            ...
            <h1 className='card_title'>Temcard</h1>
                ...
                <div className="buttons">
                    <button type="button" className="button btn-prev" onClick={handlePrev}>
                        Prev &lt;
                    </button>
                    <button type="button" className="button btn-next" onClick={handleNext}>
                        Next &gt;
                    </button>
                </div>
